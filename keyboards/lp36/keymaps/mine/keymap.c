...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        XXX,         LT(_SYM, KC_SPC), LCTL_T(KC_TAB), LT(_FUNC, KC_LNG1), LT(_NAV, KC_BSPC), XXX
    ),

    /* #1: SYMBOL */
    [_SYM] = LAYOUT(
        KC_TILD,     KC_MINS,     KC_EQL,      KC_SCLN,     KC_DQUO,       KC_PIPE,     KC_LBRC,     KC_LBRC,     KC_RBRC,     KC_RPRN,
        ...
        XXX,         _______,     _______,     _______,     _______,       XXX
    ),
    ...
    [_MAC_OVERLAY] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        XXX,     _______, LGUI_T(KC_TAB), LT(_FUNC, KC_SPC), _______, XXX
    ),
};
...
#define COMBO_LIST \
    ...
    \
    /* THUMB */\
    COMBO_X(CB_L_THUMB,  LGUI_T(KC_ESC), LT(_SYM, KC_SPC), LCTL_T(KC_TAB)) \
    COMBO_X(CB_R_THUMB,  KC_DEL,         LT(_FUNC, KC_LNG1), LT(_NAV, KC_BSPC)) \
    \
    /* BOOTLOADER */\
