...
// execute when keyboard is plug. 
void keyboard_post_init_user(void) {
    // make sure _WIN_FLAG layer is on when start
    if (is_mac_mode) {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        /**/                            KC_L_THM,       SYM_T(KC_SPC), LCTL_T(KC_TAB),  /**/    FUNC_T(KC_LNG1),NAV_T(KC_BSPC), KC_R_THM
    ),
    ...
    [_MAC_OVERLAY] = LAYOUT(
        ...
        _______,        _______,        _______,        _______,        _______,        /**/    _______,        _______,        _______,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,        /**/    _______,        _______,        _______,        _______,        _______,
        /**/                            _______,        _______,        LGUI_T(KC_TAB), /**/    FUNC_T(KC_F18), _______,        _______ 
    ),
...
// ** KEY OVERRIDES ** //
const key_override_t win_alt_left  = ko_make_with_layers(MOD_MASK_ALT, KC_LEFT,  C(KC_LEFT),  (1 << _WIN_FLAG));
const key_override_t win_alt_right = ko_make_with_layers(MOD_MASK_ALT, KC_RIGHT, C(KC_RIGHT), (1 << _WIN_FLAG));
const key_override_t win_alt_bs    = ko_make_with_layers(MOD_MASK_ALT, KC_BSPC,  C(KC_BSPC),  (1 << _WIN_FLAG));

const key_override_t win_cmd_left  = ko_make_with_layers(MOD_MASK_CTRL, KC_LEFT,  KC_HOME,     (1 << _WIN_FLAG));
const key_override_t win_cmd_right = ko_make_with_layers(MOD_MASK_CTRL, KC_RIGHT, KC_END,      (1 << _WIN_FLAG));
const key_override_t win_cmd_up    = ko_make_with_layers(MOD_MASK_CTRL, KC_UP,    C(KC_HOME),  (1 << _WIN_FLAG));
const key_override_t win_cmd_down  = ko_make_with_layers(MOD_MASK_CTRL, KC_DOWN,  C(KC_END),   (1 << _WIN_FLAG));

const key_override_t *key_overrides[] = {
    &win_alt_left, &win_alt_right, &win_alt_bs,
    &win_cmd_left, &win_cmd_right, 
    &win_cmd_up,   &win_cmd_down,
